...
public class Runtime {
	...
	static String gkvEls = "";
	static String gkvWhl = "";
	static String gkvRcr = "";
...
//		String fileName = "D:/SER-502/GKV/Sample-Programs/Intermediate-Code/RecursionFactorial.igkv";
		String line = null;
		try {
			FileReader fileReader = 
					new FileReader(fileName);
				...
				if(line.startsWith("CALL")){
					...
					for(int i=count; i>0; i--){
						...
						if(funcName.equals(gkvEls)){
							...
							System.exit(0);
						}else if(funcName.equals(gkvWhl)){
							int value = map.get("parameter1");
							...
							System.exit(0);
						}else if(funcName.equals(gkvRcr)){
							int value1 = map.get("parameter1");
							int value2 = map.get("parameter2");
							int divisor = 1;
							int result1 =0;
